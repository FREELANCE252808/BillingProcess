...
import { EmailsSMSTemplateRoutingModule } from './emailsSMSTemplate-routing.module';
...
@NgModule({
	declarations: [EmailEditComponent,EmailViewComponent],

	  imports: [ CommonModule,MatProgressBarModule,MatTabsModule,
		MatSnackBarModule,QuillModule,
		...
		EmailsSMSTemplateRoutingModule,ReactiveFormsModule,	FormsModule,CommonModule, MatButtonModule, MatCheckboxModule, MatToolbarModule, MatCardModule, MatInputModule, MatProgressSpinnerModule, MatDialogModule, MatDatepickerModule,
...
export class EmailsSMSTemplateModule { }
