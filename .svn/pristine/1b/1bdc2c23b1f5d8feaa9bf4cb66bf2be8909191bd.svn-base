...
import { UpdateEntityDialogComponent } from '../_shared/UpdateEntryDialog/update-entity-dialog.component';
...
export class LayoutUtilsService {
	...
	showActionNotification(
		...
		undoButtonDuration: number = 1000,
	...
	UpdateElement(title: string = '', description: string = '', waitDesciption: string = '') {
