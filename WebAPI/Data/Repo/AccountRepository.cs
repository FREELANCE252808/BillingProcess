    ...
    public class AccountRepository : IAccountRepository
    {
        ...
        public async Task<bool> SendEmailToUserForgotPwd(User userObj)
        {
            ...
            try
            {
                ...
                EmailSMSTemplate objBEEmailTemplate =await dc.EmailSMSTemplate.FirstOrDefaultAsync(a=>a.EmailDesc == EmailTemplate && a.CompanyID == userObj.CompanyID && a.Status == "A");
